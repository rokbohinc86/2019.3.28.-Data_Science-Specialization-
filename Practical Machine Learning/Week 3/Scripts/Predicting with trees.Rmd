...
4. In each leave-prediction you want a homogeneous prediction, a node is a separator
...
__Deviance(natural logarith)/information gain(log with base 2)__:
...
## Prettier plots with the Rattle package
