...
1. Assume the data follow a probabilistic model - follow a specific distribution
...
modlda = train(Species ~ .,data=training,method="lda") # linear discriminative analysis
