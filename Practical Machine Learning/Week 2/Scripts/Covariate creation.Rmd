...
Creating a features from spam email.

![](/home/rok/Edjucation/2019.3.28. Data_Science-Specialization/Practical Machine Learning/Week 2/Scripts/assets/img/08_PredictionAndMachineLearning/covCreation1.png)

**Level 2: Transforming tidy covariates** 

Then you may want to transform the created features.
...
* Covariate creations depends heavily on application
...
## Factor variables -> dummy variables
...
nsv
```
You should use the nzv column o throuw out variables which have no variability
...
Here you want polinomials of your variable, so underneeth you make variables up to third order
...
```{r ,dependson="splines",fig.height=4,fig.width=4}
b <- head(predict(bsBasis,age=testing$age))
a == b
```

I don't really get it, you are using the variables from the training set in the test set. So you are ignoring what the age is in the test set which is conterintuitive.
